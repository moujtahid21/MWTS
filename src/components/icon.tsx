...
/* MW Transport Service — icon set (lucide-style, hand-built). Ported from app/icons.jsx */
const ICON_PATHS: Record<string, string> = {
  ...
  drivers: '<path d="M19 17h2v-3.5a2 2 0 0 0-.6-1.4l-2-2A2 2 0 0 0 17 9.5H6.8a2 2 0 0 0-1.9 1.3L3 17h2"/><circle cx="7.5" cy="17.5" r="2"/><circle cx="16.5" cy="17.5" r="2"/><path d="M3 13h18"/>',
  ...
  truck: '<path d="M19 17h2v-3.5a2 2 0 0 0-.6-1.4l-2-2A2 2 0 0 0 17 9.5H14V17h1"/><path d="M3 17V5a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v12"/><circle cx="7.5" cy="17.5" r="2"/><circle cx="17.5" cy="17.5" r="2"/>',
  ...
  euro: '<path d="M14 21a8 8 0 1 1 0-16M4 11h10M4 15h8"/>',
  ...
  pkg: '<path d="m7.5 4.27 9 5.15M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5M12 22V12"/>',
  ...
  pdf: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 15h1.5a1.5 1.5 0 0 0 0-3H9v6M15 18v-6h1.5"/>',
  excel: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M9 13l2 3 2-3M9 19l2-3 2 3"/>',
  ...
  coffee: '<path d="M10 2v2M14 2v2M16 8a4 4 0 0 1 0 8h-1M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z"/>',
  ...
  calRange: '<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18M8 14h.01M12 14h3M8 18h.01M12 18h3"/>',
...
export function Icon({ name, size = 18, sw = 2, style, className }: { name: string; size?: number; sw?: number; style?: React.CSSProperties; className?: string }) {
  return (
